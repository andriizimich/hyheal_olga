    ...
    <div className="p-6">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-6">
        ...
        <div className="flex items-center gap-2 ml-auto">
          <button disabled className="rounded-md bg-slate-100 text-slate-400 text-[11px] font-medium px-3 py-1.5">
            Завершити
          </button>
          <button disabled className="rounded-md bg-slate-100 text-slate-400 text-[11px] font-medium px-3 py-1.5">
            Відмінити
          ...
          <button
            ...
            className="rounded-md bg-[#5b7ee5] text-white text-[11px] font-semibold px-3 py-1.5 hover:bg-[#4c6fd6] transition"
          >
            Створити прийом
          </button>
          <button
            onClick={() => navigate("/treatment-plans")}
            className="rounded-md border border-slate-200 text-slate-600 text-[11px] font-medium px-3 py-1.5 hover:bg-slate-50 transition"
          >
